...
if __name__=="__main__":
    ...
    import profile
    def run():
        res = idcard_recognize.process('testimages/8nbSJPQIyEytk5G4FTseYMGRZRAXN3thllA0mFoiCnh2q7SspZBIT__amOyYsf13.jpg')
        print(res)
    
    profile.run("run()")

    # https://img.meihaofenqi.net/C_Q3hvni2asdSvlImTa1eqFM3hf7Hrj7db0Cp66s7fJBbmMvDkyJukS_lXDOvX_K
    # p = Pool()
